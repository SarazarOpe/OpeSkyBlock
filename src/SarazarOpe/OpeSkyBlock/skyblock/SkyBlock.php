...
namespace SarazarOpe\OpeSkyBlock\skyblock;
...
class SkyBlock {
  ...
  public function genWorld(string $newName, string $type) {
    $skyblock = OpeSkyBlock::getInstance();
  ...
  public function teleport(Player $player, string $islandName) {
    $islandName = strtolower($islandName);
    $worldManager = OpeSkyBlock::getInstance()->getWorldManager();
  ...
  public function setSpawn(string $islandName, Position $position) {
    $islandName = strtolower($islandName);
    $world = OpeSkyBlock::getInstance()->getWorldManager()->getWorldByName($islandName);
  ...
  public function getBlocks() {
    $config = OpeSkyBlock::getInstance()->getDataManager();
